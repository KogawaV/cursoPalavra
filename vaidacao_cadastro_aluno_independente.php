<?php 
    ...
    if(isset($_POST['nome_aluno']) && isset($_POST['email_aluno']) && isset($_POST['cpf_aluno']) && isset($_POST['senha_aluno'])){
        ...
        if($sql_verifica_aluno_no_bd_result){
            ...
            if($row_verifica_aluno >= 1){
                ...
                $sql_select_texto_tipo_plano = "SELECT * FROM tipos_planos WHERE id_tipo_plano = $id_plano_url";
                ...
                if($sql_select_texto_tipo_plano_result){
                    ...
                    if($sql_insert_aluno_result){//insert deu certo
                        ...
                        header('Location: ./pagseguro_slide/planos.php?cpf='.$cpf_aluno.'&id_plano='.$id_plano_url);
                        /*if($id_aluno != 0){
                            //echo date();
                            $data_compra = "now()";
